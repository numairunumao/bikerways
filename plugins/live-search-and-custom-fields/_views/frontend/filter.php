...
<div class="px-capf-wrapper row <?php echo esc_attr( $wrapper_class ); ?>" ng-app="px-capf">
	...
	<div class="col-sm-12 col-md-12 col-lg-12 lscf-container <?php echo esc_attr( $container_class )?>" ng-controller="pxfilterController" >
		...
		<div 
			...
			<div ng-if="pluginSettings.filterSettings.theme.sidebar.position == 'left' || pluginSettings.filterSettings.theme.sidebar.position == 'top' " 
			...
			<div class="{{ 'col-xs-12 ' + pluginSettings.className.posts_theme + 'lscf-posts' }} ">
				...
				<div class="no-filter-results-error px-hide" ng-class="{'ang_ready' : loadMoreBtn.ready}" ng-if="loadMoreBtn.noResults">{{pluginSettings.generalSettings.writing.no_results}}</div>
