...
angular.module(angAppName)
	.controller("pxfilterController", ['$scope', '$sce', 'customFilterService', function ($scope, $sce, customFilterService ) {
				...
				lscf_initLiveSearch(function(){
					...
					$j('.lscf-live-search-input').focus(function(){
						...
						if ( true === scope.actionSettings.lsLoadPosts ) {
							...
							customFilterService.getAllPosts( scope.postType, 200, 1, activeQuery )
								.success( function( data ) {
